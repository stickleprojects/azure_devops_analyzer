...
pytest tests/contract/integration/ -m "live_api" -v
```
...
pytest tests/contract/integration/ -m "not slow and not live_api" -v
...
pytest tests/contract/integration/ --collect-only -q
```

## File Reference

- [conftest.py](tests/contract/integration/conftest.py) - All fixtures
- [GitHub Extraction Tests](tests/contract/integration/test_github_extraction_e2e.py) - E2E tests
- [Enrichment Tests](tests/contract/integration/test_dependency_enrichment_e2e.py) - Enrichment E2E
- [Test Guide](tests/contract/integration/README.md) - Complete documentation
...
3. **Run tests:** `pytest tests/contract/integration/ -m "not live_api" -v`
