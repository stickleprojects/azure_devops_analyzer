...
**Generation Pattern**: Ollama-in-Docker (see `.ai/patterns/ollama-docker-codegen.md`)

**Implementation Summary**: All deliverables are generated using local LLM (Ollama with qwen3-coder:30b) following detailed prompts in `.ai/ollama-prompts/fixture-*.md`. Regenerate anytime with `bash scripts/generate-test-fixtures.sh`. Generated test scenarios now support branches, commits, and pull requests for workflow testing.
...
**Pattern Documentation**: `.ai/patterns/ollama-docker-codegen.md`
