...
Plan 016 reporting-view migration is complete for dashboard SQL and dashboard template selectors.
...
- Dashboard selectors/variables are also view-backed, eliminating direct dashboard references to base tables.
...
- `33 passed`
- Global totals used by dashboards match expected fixture-backed values in `v_commits_total`, `v_contributors_total`, `v_pull_requests_total`, `v_prs_created_30d_total`, `v_pr_reviews_30d_total`, and `v_teams_total`.
